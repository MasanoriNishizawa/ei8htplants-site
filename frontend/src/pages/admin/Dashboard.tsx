    ...
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(180px, 1fr))', gap: 16, marginBottom: 40 }}>
        {statCards.map(({ label, value, to, urgent }) => (
          <Link key={to} to={to} style={{ textDecoration: 'none', display: 'block', padding: '20px 24px', background: urgent ? '#fff8f0' : '#fffcf6', border: `1px solid ${urgent ? '#e8c870' : '#ddd4c0'}`, borderRadius: 12 }}>
